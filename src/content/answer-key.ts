...
const unit1AnswerKey: TeacherAnswerEntry[] = [
  ...
  },
  {
    ...
    answer: [
      ...
      'לא נכון — ההשלמה מובטחת רק בין ישרים מקבילים; כשהישרים אינם מקבילים סכום הזוויות החד-צדדיות שונה מ־180°.',
    ],
  },
  ...
  },
  {
    ...
    answer: `נועם צודק. בשרטוט שבו הישרים m ו־n מקבילים (מסומנים בחצים) הזוויות המתחלפות המסומנות שוות, כי „${THEOREMS.alternateDirect.text}” בשרטוט השני הישרים אינם מקבילים, ולכן אי אפשר לקבוע שהזוויות שוות — ואכן אחת מהן גדולה מהשנייה. היותן זוויות מתחלפות אינה מספיקה; דניאל שכח את תנאי המקבילות.`,
  },
  {
