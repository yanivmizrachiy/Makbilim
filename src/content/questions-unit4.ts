...
export const unit4Questions: Unit4Question[] = [
  // עמוד 1 — שפה והפעלה ראשונה של המשפטים ההפוכים
  {
    id: 'U4-P1-A',
    page: 1,
    stem: 'השלימו את המשפט: אם שני ישרים נחתכים על ידי ישר שלישי, וזוג זוויות ______ שוות זו לזו, אז שני הישרים ______.',
    expected: { completions: ['מתאימות', 'מקבילים'] }
  },
  {
    id: 'U4-P1-B',
    page: 1,
    stem: 'השלימו במילים המתאימות: אם זוג זוויות מתחלפות הנוצרות על ידי ישר חותך ______ זו לזו, אפשר להסיק ששני הישרים ______.',
  ...
  // עמוד 2 — מספיקות נתונים, אלגברה והוכחה מסכמת
  {
    id: 'U4-P2-A',
    page: 2,
