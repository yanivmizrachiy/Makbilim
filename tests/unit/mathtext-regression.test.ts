  ...
  it('lists every reviewed difference from the original tokenizer', () => {
    ...
    expect(differences.join('\n')).toMatchInlineSnapshot(`
      ...
      U2-P6-D.stem
        ...
        + הישרים ⟦k⟧ ו־⟦m⟧ מקבילים ונחתכים על ידי שני ישרים. נתון כי ⟦∠A = 41°⟧ ו־⟦∠C = 68°⟧. חשבו את ⟦α + β⟧. נמקו כל שלב בחישוב.
      U3-P1-A.stem
        − בשרטוט ⟦p ∥ q⟧. נתון כי ⟦∠A⟧ ו־⟦∠B⟧ הן זוויות מתאימות. בחרו את הנימוק המתאים לטענה ⟦∠A⟧ = ⟦∠B⟧.
        + בשרטוט ⟦p ∥ q⟧. נתון כי ⟦∠A⟧ ו־⟦∠B⟧ הן זוויות מתאימות. בחרו את הנימוק המתאים לטענה ⟦∠A = ∠B⟧.
      ...
      U3-P1-D.stem
        ...
        + בשרטוט ⟦a ∥ b⟧. קבעו אם ⟦∠A = ∠C⟧. נמקו את קביעתכם.
      U3-P2-A.stem
        − לפניכם נימוק שכתב תלמיד: „⟦∠A⟧ = ⟦∠B⟧ כי הן זוויות מתאימות בין ישרים מקבילים”. לפי השרטוט הזוויות הן מתחלפות. מצאו את הטעות ותקנו את הנימוק.
        + לפניכם נימוק שכתב תלמיד: „⟦∠A = ∠B⟧ כי הן זוויות מתאימות בין ישרים מקבילים”. לפי השרטוט הזוויות הן מתחלפות. מצאו את הטעות ותקנו את הנימוק.
      ...
      U3-P2-C.proofLines[3].claim
        ...
        + ⟦∠A = ∠C⟧
      U3-P2-D.stem
        − המטרה היא להוכיח כי ⟦∠A⟧ = ⟦∠B⟧. איזה מן הנתונים הנוספים שלהלן מספיק לבדו להשלמת ההוכחה? נמקו.
        + המטרה היא להוכיח כי ⟦∠A = ∠B⟧. איזה מן הנתונים הנוספים שלהלן מספיק לבדו להשלמת ההוכחה? נמקו.
      U3-P2-D.choices[3]
        − AB = CD
        + ⟦AB = CD⟧
      ...
      U3-P3-B.stem
        ...
        + נתון ⟦k ∥ m⟧. הוכיחו כי ⟦∠A + ∠C = 180°⟧.
      U3-P3-C.stem
        − נתון ⟦a ∥ b⟧ וכן ⟦∠E = 35°⟧. הוכיחו כי ⟦∠A⟧ = ⟦∠D⟧. ציינו אם הנתון ⟦∠E = 35°⟧ נחוץ להוכחה.
        + נתון ⟦a ∥ b⟧ וכן ⟦∠E = 35°⟧. הוכיחו כי ⟦∠A = ∠D⟧. ציינו אם הנתון ⟦∠E = 35°⟧ נחוץ להוכחה.
      U3-P3-D.stem
        − שני תלמידים כתבו הוכחה לטענה ⟦∠A⟧ = ⟦∠C⟧. קבעו איזו הוכחה נכונה ונמקו.
        + שני תלמידים כתבו הוכחה לטענה ⟦∠A = ∠C⟧. קבעו איזו הוכחה נכונה ונמקו.
      U3-P3-D.subparts[0]
      ...
      teacher U3-P1-D.answer.proof[2] (teacher guide)
        − לכן ⟦∠A⟧ = ⟦∠C⟧.
        + לכן ⟦∠A = ∠C⟧.
      teacher U3-P2-A.answer.reason (teacher guide)
        − ⟦∠A⟧ = ⟦∠B⟧ כי זוויות מתחלפות בין ישרים מקבילים שוות זו לזו.
        + ⟦∠A = ∠B⟧ כי זוויות מתחלפות בין ישרים מקבילים שוות זו לזו.
