...
describe('MathText regression over the whole booklet corpus', () => {
  ...
  it('matches the MathJax token count recorded by the visual baseline exactly (every island the booklet renders)', () => {
    ...
    `);
  }, 30_000); // renders every MathJax island of the booklet — well over the 5 s default under a loaded CI runner
  ...
  it('lists every reviewed difference from the original tokenizer', () => {
    ...
    expect(differences.join('\n')).toMatchInlineSnapshot(`
      "U1-P3-A.stem
        − בכל אחד משני השרטוטים מסומן זוג זוויות מתחלפות. בשרטוט אחד הישרים m ו־n מקבילים (מסומנים בחצים), ובשרטוט השני הם אינם מקבילים. קראו מה טוענים דניאל ונועם, קבעו מי צודק, ציינו באיזה שרטוט אפשר לקבוע שהזוויות המסומנות שוות, ונמקו.
        + בכל אחד משני השרטוטים מסומן זוג זוויות מתחלפות. בשרטוט אחד הישרים ⟦m⟧ ו־⟦n⟧ מקבילים (מסומנים בחצים), ובשרטוט השני הם אינם מקבילים. קראו מה טוענים דניאל ונועם, קבעו מי צודק, ציינו באיזה שרטוט אפשר לקבוע שהזוויות המסומנות שוות, ונמקו.
      U2-P1-A.stem
      ...
      U2-P1-D.stem
        ...
        + הישרים ⟦r⟧ ו־⟦s⟧ מקבילים. נתון כי ⟦∠E = 116°⟧. חשבו את ⟦α⟧ ונמקו.
      U2-P2-A.stem
        − בשרטוט ⟦p ∥ q⟧ ⟦(הישרים p ו־q מקבילים)⟧. נתון ⟦∠A = 63°⟧. חשבו את ⟦β⟧.
        + בשרטוט ⟦p ∥ q⟧ (הישרים ⟦p⟧ ו־⟦q⟧ מקבילים). נתון ⟦∠A = 63°⟧. חשבו את ⟦β⟧.
      U2-P2-B.stem
      ...
      U2-P2-C.stem
        ...
        + בשרטוט הישרים ⟦c⟧ ו־⟦d⟧ מקבילים. נתון כי ⟦∠F = 72°⟧. מצאו את ⟦δ⟧.
      U2-P3-B.stem
        − בשרטוט הישרים k ו־m מקבילים. נתון כי ⟦∠A = 52°⟧. לכל אחת מן הזוויות ⟦∠D⟧ ו־⟦∠F⟧ רשמו בטבלה את סוג הקשר לזווית שלפניה ואת גודלה.
        + בשרטוט הישרים ⟦k⟧ ו־⟦m⟧ מקבילים. נתון כי ⟦∠A = 52°⟧. לכל אחת מן הזוויות ⟦∠D⟧ ו־⟦∠F⟧ רשמו בטבלה את סוג הקשר לזווית שלפניה ואת גודלה.
      U2-P3-D.stem
        − הישרים a ו־b מקבילים ונחתכים על ידי שני ישרים שונים. נתון כי ⟦∠A = 49°⟧ ו־⟦∠C = 73°⟧. חשבו את ⟦α⟧ ואת ⟦β⟧.
        + הישרים ⟦a⟧ ו־⟦b⟧ מקבילים ונחתכים על ידי שני ישרים שונים. נתון כי ⟦∠A = 49°⟧ ו־⟦∠C = 73°⟧. חשבו את ⟦α⟧ ואת ⟦β⟧.
      U2-P4-A.stem
        − בשרטוט ⟦p ∥ q⟧. גודלי שתי הזוויות המסומנות הם ⟦4x + 6⟧° ו־⟦2x + 38⟧°. זהו את סוג הזוויות, כתבו את המשפט המתאים, מצאו את ⟦x⟧ וחשבו את גודל הזוויות.
        + בשרטוט ⟦p ∥ q⟧. גודלי שתי הזוויות המסומנות הם ⟦4x + 6°⟧ ו־⟦2x + 38°⟧. זהו את סוג הזוויות, כתבו את המשפט המתאים, מצאו את ⟦x⟧ וחשבו את גודל הזוויות.
      U2-P4-B.stem
        − הישרים k ו־m מקבילים. שתי הזוויות המסומנות הן ⟦3x + 17⟧° ו־⟦5x − 21⟧°. איזה סוג זוויות הן? כתבו את המשפט המתאים, מצאו את ⟦x⟧ ואת גודל הזוויות.
        + הישרים ⟦k⟧ ו־⟦m⟧ מקבילים. שתי הזוויות המסומנות הן ⟦3x + 17°⟧ ו־⟦5x − 21°⟧. איזה סוג זוויות הן? כתבו את המשפט המתאים, מצאו את ⟦x⟧ ואת גודל הזוויות.
      U2-P4-C.stem
        − בשרטוט ⟦a ∥ b⟧. הזוויות המסומנות הן ⟦6x − 9⟧° ו־⟦3x + 42⟧°. זהו את סוג הזוויות ורשמו את המשפט המתאים. מצאו את ⟦x⟧ ולאחר מכן חשבו את גודלן של הזוויות המסומנות.
        + בשרטוט ⟦a ∥ b⟧. הזוויות המסומנות הן ⟦6x − 9°⟧ ו־⟦3x + 42°⟧. זהו את סוג הזוויות ורשמו את המשפט המתאים. מצאו את ⟦x⟧ ולאחר מכן חשבו את גודלן של הזוויות המסומנות.
      U2-P4-D.stem
        − בשרטוט הישרים r ו־s מקבילים. גודלי שתי הזוויות המסומנות הם ⟦2x + 35⟧° ו־⟦5x − 19⟧°. זהו את סוג הזוויות, בחרו את המשוואה המתאימה, נמקו ופתרו, וחשבו את גודל הזוויות.
        + בשרטוט הישרים ⟦r⟧ ו־⟦s⟧ מקבילים. גודלי שתי הזוויות המסומנות הם ⟦2x + 35°⟧ ו־⟦5x − 19°⟧. זהו את סוג הזוויות, בחרו את המשוואה המתאימה, נמקו ופתרו, וחשבו את גודל הזוויות.
      U2-P4-D.choices[1]
        − ⟦2x + 35⟧ + ⟦5x − 19 = 180⟧
        + ⟦2x + 35 + 5x − 19 = 180⟧
      U2-P4-D.choices[2]
        ...
        + ⟦2x + 35 + 5x − 19 = 90⟧
      U2-P5-A.stem
        − בשרטוט ⟦p ∥ q⟧. גודלי שתי הזוויות המסומנות הם ⟦7x − 18⟧° ו־⟦3x + 38⟧°. מצאו את ⟦x⟧ ואת גודלה של כל אחת מהזוויות. נמקו כל שלב.
        + בשרטוט ⟦p ∥ q⟧. גודלי שתי הזוויות המסומנות הם ⟦7x − 18°⟧ ו־⟦3x + 38°⟧. מצאו את ⟦x⟧ ואת גודלה של כל אחת מהזוויות. נמקו כל שלב.
      U2-P5-B.stem
        − הישרים c ו־d מקבילים. גודלי שתי הזוויות המסומנות הם ⟦4x + 15⟧° ו־⟦2x + 63⟧°. זהו את סוג הזוויות, כתבו את המשפט, מצאו את ⟦x⟧ ואת גודל הזוויות.
        + הישרים ⟦c⟧ ו־⟦d⟧ מקבילים. גודלי שתי הזוויות המסומנות הם ⟦4x + 15°⟧ ו־⟦2x + 63°⟧. זהו את סוג הזוויות, כתבו את המשפט, מצאו את ⟦x⟧ ואת גודל הזוויות.
      U2-P5-C.stem
        − בשרטוט ⟦p ∥ q⟧ ושני ישרים חותכים אותם. בזוג זוויות אחד הגדלים הם ⟦3x + 12⟧° ו־⟦72°⟧, ובזוג השני ⟦2y + 18⟧° ו־⟦94°⟧. זהו את סוג כל זוג, כתבו את המשפטים המתאימים ומצאו את ⟦x⟧ ואת ⟦y⟧.
        + בשרטוט ⟦p ∥ q⟧ ושני ישרים חותכים אותם. בזוג זוויות אחד הגדלים הם ⟦3x + 12°⟧ ו־⟦72°⟧, ובזוג השני ⟦2y + 18°⟧ ו־⟦94°⟧. זהו את סוג כל זוג, כתבו את המשפטים המתאימים ומצאו את ⟦x⟧ ואת ⟦y⟧.
      U2-P5-D.stem
        − הישרים a ו־b מקבילים. דני כתב את המשוואה ⟦2x + 20 = 3x + 35 ⟧והסביר: „הישרים מקבילים, ולכן שתי הזוויות המסומנות שוות.” קבעו אם המשוואה וההסבר נכונים. אם לא, כתבו משוואה נכונה, נמקו, מצאו את ⟦x⟧ וחשבו את גודל שתי הזוויות.
        + הישרים ⟦a⟧ ו־⟦b⟧ מקבילים. דני כתב את המשוואה ⟦2x + 20 = 3x + 35⟧ והסביר: „הישרים מקבילים, ולכן שתי הזוויות המסומנות שוות.” קבעו אם המשוואה וההסבר נכונים. אם לא, כתבו משוואה נכונה, נמקו, מצאו את ⟦x⟧ וחשבו את גודל שתי הזוויות.
      U2-P6-D.stem
        − הישרים k ו־m מקבילים ונחתכים על ידי שני ישרים. נתון כי ⟦∠A = 41°⟧ ו־⟦∠C = 68°⟧. חשבו את ⟦α⟧ + ⟦β⟧. נמקו כל שלב בחישוב.
        + הישרים ⟦k⟧ ו־⟦m⟧ מקבילים ונחתכים על ידי שני ישרים. נתון כי ⟦∠A = 41°⟧ ו־⟦∠C = 68°⟧. חשבו את ⟦α + β⟧. נמקו כל שלב בחישוב.
      U3-P1-A.stem
      ...
      U3-P3-D.subparts[1]
        ...
        + הוכחה ב: ⟦∠A = ∠C⟧ כי שתיהן זוויות מתחלפות, ולכן הן שוות.
      U4-P2-A.stem
        − בשרטוט הישרים k ו־m נחתכים על ידי הישר r. נתון כי ⟦∠C = 112°⟧ ו־⟦∠D = 112°⟧. ציינו אם ⟦∠C⟧ ו־⟦∠D⟧ הן זוויות מתאימות או מתחלפות, וקבעו אם ⟦k ∥ m⟧. נמקו.
        + בשרטוט הישרים ⟦k⟧ ו־⟦m⟧ נחתכים על ידי הישר ⟦r⟧. נתון כי ⟦∠C = 112°⟧ ו־⟦∠D = 112°⟧. ציינו אם ⟦∠C⟧ ו־⟦∠D⟧ הן זוויות מתאימות או מתחלפות, וקבעו אם ⟦k ∥ m⟧. נמקו.
      U4-P2-B.stem
        − הישר t חותך את p ו־q. קבעו אם כל טענה נכונה, ונמקו.
        + הישר ⟦t⟧ חותך את ⟦p⟧ ו־⟦q⟧. קבעו אם כל טענה נכונה, ונמקו.
      U4-P2-B.subparts[0]
      ...
      U4-P2-B.subparts[4]
        ...
        + אם זוג זוויות חד-צדדיות בין ⟦p⟧ ו־⟦q⟧ משלימות ל־⟦180°⟧, אז ⟦p⟧ ו־⟦q⟧ מקבילים.
      U4-P2-C.stem
        − הישרים p ו־q נחתכים על ידי ישר שלישי. גודלי שתי זוויות מתאימות הם ⟦3x + 14⟧° ו־⟦5x − 26⟧°. מצאו את ⟦x⟧ כך שניתן יהיה לקבוע כי ⟦p ∥ q⟧, וחשבו את גודל הזוויות המתאימות עבור ⟦x⟧ זה. נמקו.
        + הישרים ⟦p⟧ ו־⟦q⟧ נחתכים על ידי ישר שלישי. גודלי שתי זוויות מתאימות הם ⟦3x + 14°⟧ ו־⟦5x − 26°⟧. מצאו את ⟦x⟧ כך שניתן יהיה לקבוע כי ⟦p ∥ q⟧, וחשבו את גודל הזוויות המתאימות עבור ⟦x⟧ זה. נמקו.
      U4-P2-D.stem
      ...
      src/pages/Unit1Continuation.tsx literal (printed verbatim, not through MathText)
        − ∠8
        + ⟦∠8⟧
      src/pages/Unit2Pages.tsx literal (printed verbatim, not through MathText)
        − ⟦4x + 6⟧°
        + ⟦4x + 6°⟧
      src/pages/Unit2Pages.tsx literal (printed verbatim, not through MathText)
        − ⟦2x + 38⟧°
      ...
      src/pages/Unit4Pages.tsx literal (printed verbatim, not through MathText)
        ...
        + שלושה ישרים ⟦p⟧, ⟦q⟧, ⟦r⟧ וישר חותך; ⟦p⟧ ו־⟦q⟧ מסומנים כמקבילים
      teacher U1-P5-C.note (teacher guide)
        − השורה הראשונה משלימה את המשפט „זוויות חד-צדדיות בין ישרים מקבילים משלימות ל־⟦180°⟧.”; בשורה השנייה: ⟦180°⟧ − ⟦70°⟧ = ⟦110°⟧.
        + השורה הראשונה משלימה את המשפט „זוויות חד-צדדיות בין ישרים מקבילים משלימות ל־⟦180°⟧.”; בשורה השנייה: ⟦180° − 70° = 110°⟧.
      ...
      teacher U1-P3-A.answer (teacher guide)
        − נועם צודק. בשרטוט שבו הישרים m ו־n מקבילים (מסומנים בחצים) הזוויות המתחלפות המסומנות שוות, כי „זוויות מתחלפות בין ישרים מקבילים שוות.” בשרטוט השני הישרים אינם מקבילים, ולכן אי אפשר לקבוע שהזוויות שוות — ואכן אחת מהן גדולה מהשנייה. היותן זוויות מתחלפות אינה מספיקה; דניאל שכח את תנאי המקבילות.
        + נועם צודק. בשרטוט שבו הישרים ⟦m⟧ ו־⟦n⟧ מקבילים (מסומנים בחצים) הזוויות המתחלפות המסומנות שוות, כי „זוויות מתחלפות בין ישרים מקבילים שוות.” בשרטוט השני הישרים אינם מקבילים, ולכן אי אפשר לקבוע שהזוויות שוות — ואכן אחת מהן גדולה מהשנייה. היותן זוויות מתחלפות אינה מספיקה; דניאל שכח את תנאי המקבילות.
      teacher U1-P3-D.answer[1] (teacher guide)
        ...
        + חסר התנאי שהישרים מקבילים. בשרטוט השני הישרים ⟦h⟧ ו־⟦k⟧ אינם מקבילים, והזוויות המתאימות המסומנות אינן שוות — לכן המשפט של מאיה, בלי תנאי המקבילות, אינו נכון.
      teacher U2-P2-A.note (teacher guide)
        − גם הסדר ההפוך נכון: הזווית הצמודה ל־⟦∠A⟧ היא ⟦117°⟧, ו־⟦β⟧ מתחלפת לה. נכונה גם דרך בשלב אחד: ⟦∠A⟧ ו־⟦β⟧ הן זוויות חד-צדדיות, ולכן ⟦β⟧ = ⟦180°⟧ − ⟦63°⟧ = ⟦117°⟧ — זוויות חד-צדדיות בין ישרים מקבילים משלימות ל־⟦180°⟧. תשובה של ⟦63°⟧ מעתיקה את ⟦∠A⟧ בלי לזהות ש־⟦β⟧ צמודה לזווית המתאימה ל־⟦∠A⟧.
        + גם הסדר ההפוך נכון: הזווית הצמודה ל־⟦∠A⟧ היא ⟦117°⟧, ו־⟦β⟧ מתחלפת לה. נכונה גם דרך בשלב אחד: ⟦∠A⟧ ו־⟦β⟧ הן זוויות חד-צדדיות, ולכן ⟦β = 180° − 63° = 117°⟧ — זוויות חד-צדדיות בין ישרים מקבילים משלימות ל־⟦180°⟧. תשובה של ⟦63°⟧ מעתיקה את ⟦∠A⟧ בלי לזהות ש־⟦β⟧ צמודה לזווית המתאימה ל־⟦∠A⟧.
      teacher U2-P2-B.note (teacher guide)
        − נכונה גם דרך בשלב אחד: הזווית של ⟦137°⟧ ו־⟦γ⟧ הן זוויות חד-צדדיות, ולכן ⟦γ⟧ = ⟦180°⟧ − ⟦137°⟧ = ⟦43°⟧ — זוויות חד-צדדיות בין ישרים מקבילים משלימות ל־⟦180°⟧.
        + נכונה גם דרך בשלב אחד: הזווית של ⟦137°⟧ ו־⟦γ⟧ הן זוויות חד-צדדיות, ולכן ⟦γ = 180° − 137° = 43°⟧ — זוויות חד-צדדיות בין ישרים מקבילים משלימות ל־⟦180°⟧.
      teacher U2-P5-A.note (teacher guide)
        − המשוואה: ⟦7x − 18⟧ + ⟦3x + 38 = 180⟧. השוואת שני הביטויים זה לזה נותנת ⟦x⟧ = 14 ושתי זוויות של ⟦80°⟧ — אבל הזוויות המסומנות אינן מתאימות: הזווית ב־q צמודה לזווית המתאימה לזווית שב־p.
        + המשוואה: ⟦7x − 18 + 3x + 38 = 180⟧. השוואת שני הביטויים זה לזה נותנת ⟦x = 14⟧ ושתי זוויות של ⟦80°⟧ — אבל הזוויות המסומנות אינן מתאימות: הזווית ב־⟦q⟧ צמודה לזווית המתאימה לזווית שב־⟦p⟧.
      teacher U2-P5-D.answer.justification (teacher guide)
        − זוויות צמודות משלימות ל־⟦180°⟧. המשוואה הנכונה: ⟦2x + 20⟧ + ⟦3x + 35 = 180⟧.
        + זוויות צמודות משלימות ל־⟦180°⟧. המשוואה הנכונה: ⟦2x + 20 + 3x + 35 = 180⟧.
      teacher U2-P5-D.note (teacher guide)
        − המשוואה וההסבר שגויים: שתי הזוויות המסומנות נמצאות באותה נקודת חיתוך — הן צמודות, לא מתאימות ולא מתחלפות, ולכן המקבילות אינה נותנת כאן שוויון. המשוואה של דני נותנת ⟦x⟧ = −15, כלומר זוויות של −⟦10°⟧.
        + המשוואה וההסבר שגויים: שתי הזוויות המסומנות נמצאות באותה נקודת חיתוך — הן צמודות, לא מתאימות ולא מתחלפות, ולכן המקבילות אינה נותנת כאן שוויון. המשוואה של דני נותנת ⟦x = −15⟧, כלומר זוויות של ⟦−10°⟧.
      teacher U2-P6-B.note (teacher guide)
        − גם הדרך דרך הזווית המתאימה ל־⟦118°⟧ במסילה השנייה, ולאחריה הזווית הצמודה לה, נכונה. תשובה של ⟦118°⟧ מעתיקה את הזווית הנתונה בלי השלב של הזווית הצמודה. נכונה גם דרך בשלב אחד: הזווית של ⟦118°⟧ והזווית המסומנת ב־? הן זוויות חד-צדדיות בין המסילות, ולכן ? = ⟦180°⟧ − ⟦118°⟧ = ⟦62°⟧.
        + גם הדרך דרך הזווית המתאימה ל־⟦118°⟧ במסילה השנייה, ולאחריה הזווית הצמודה לה, נכונה. תשובה של ⟦118°⟧ מעתיקה את הזווית הנתונה בלי השלב של הזווית הצמודה. נכונה גם דרך בשלב אחד: הזווית של ⟦118°⟧ והזווית המסומנת ב־? הן זוויות חד-צדדיות בין המסילות, ולכן ? = ⟦180° − 118° = 62°⟧.
      ...
      teacher U3-P3-B.answer.proof[2] (teacher guide)
        − לכן ⟦∠A⟧ + ⟦∠C = 180°⟧.
        + לכן ⟦∠A + ∠C = 180°⟧.
      teacher U3-P3-B.note (teacher guide)
        − גם הוכחה בשלב אחד נכונה, כי ⟦∠A⟧ ו־⟦∠C⟧ הן זוויות חד-צדדיות: ⟦∠A⟧ + ⟦∠C = 180°⟧ — זוויות חד-צדדיות בין ישרים מקבילים משלימות ל־⟦180°⟧. שתי הדרכים מתקבלות.
        + גם הוכחה בשלב אחד נכונה, כי ⟦∠A⟧ ו־⟦∠C⟧ הן זוויות חד-צדדיות: ⟦∠A + ∠C = 180°⟧ — זוויות חד-צדדיות בין ישרים מקבילים משלימות ל־⟦180°⟧. שתי הדרכים מתקבלות.
      ...
      teacher U3-P3-D.answer.reason[2] (teacher guide)
        ...
        + תיקון להוכחה ב: ⟦∠A = ∠C⟧ כי הן זוויות מתחלפות בין הישרים המקבילים ⟦p⟧ ו־⟦q⟧.
      teacher U4-P2-B.answer.reason[0] (teacher guide)
        − לא נכון — זוויות קודקודיות שוות. זה מתקיים תמיד, גם כשהישרים אינם מקבילים, ושתי הזוויות באותו חיתוך; אין בכך מידע על הישר q.
        + לא נכון — זוויות קודקודיות שוות. זה מתקיים תמיד, גם כשהישרים אינם מקבילים, ושתי הזוויות באותו חיתוך; אין בכך מידע על הישר ⟦q⟧.
      teacher U4-P2-B.answer.reason[3] (teacher guide)
        − לא נכון — זוויות צמודות משלימות ל־⟦180°⟧. זה מתקיים תמיד, גם כשהישרים אינם מקבילים, ושתי הזוויות באותו חיתוך; אין בכך מידע על הישר p.
        + לא נכון — זוויות צמודות משלימות ל־⟦180°⟧. זה מתקיים תמיד, גם כשהישרים אינם מקבילים, ושתי הזוויות באותו חיתוך; אין בכך מידע על הישר ⟦p⟧.
      ...
      teacher U4-P2-D.answer.proof[0] (teacher guide)
        − ⟦∠A⟧ = ⟦∠B⟧ — זוויות מתאימות בין ישרים מקבילים שוות. ⟦(p ∥ q נתון)⟧
        + ⟦∠A = ∠B⟧ — זוויות מתאימות בין ישרים מקבילים שוות. (⟦p ∥ q⟧ נתון)
