  ...
  it('lists every reviewed difference from the original tokenizer', () => {
    ...
    expect(differences.join('\n')).toMatchInlineSnapshot(`
      ...
      U3-P3-D.subparts[1]
        ...
        + הוכחה ב: ⟦∠A = ∠C⟧ כי שתיהן זוויות מתחלפות, ולכן הן שוות.
      U4-P2-A.stem
        − בשרטוט הישרים k ו־m נחתכים על ידי הישר r. נתון כי ⟦∠C = 112°⟧ ו־⟦∠D = 112°⟧. זהו אם ⟦∠C⟧ ו־⟦∠D⟧ הן זוויות מתאימות או מתחלפות, וקבעו אם ⟦k ∥ m⟧. נמקו.
        + בשרטוט הישרים ⟦k⟧ ו־⟦m⟧ נחתכים על ידי הישר ⟦r⟧. נתון כי ⟦∠C = 112°⟧ ו־⟦∠D = 112°⟧. זהו אם ⟦∠C⟧ ו־⟦∠D⟧ הן זוויות מתאימות או מתחלפות, וקבעו אם ⟦k ∥ m⟧. נמקו.
      U4-P2-B.stem
        − הישרים p ו־q נחתכים על ידי הישר t. קבעו ליד כל טענה אם היא נכונה או לא נכונה, ונמקו.
        + הישרים ⟦p⟧ ו־⟦q⟧ נחתכים על ידי הישר ⟦t⟧. קבעו ליד כל טענה אם היא נכונה או לא נכונה, ונמקו.
      U4-P2-B.subparts[0]
